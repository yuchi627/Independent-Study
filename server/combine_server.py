...
#        cv2.waitKey(0)
    ...
    def draw_layer(self,num):
        ...
        for i in range(4):
            ...
            left_spot_x = 5 + (self.middle_x-5)*(i%2)
            right_spot_x = self.middle_x + self.middle_x*(i%2)
            up_spot_y = 5 + (self.middle_y-5)*(i >= 2)
            down_spot_y = self.middle_y + (self.middle_y)*(i >= 2)
